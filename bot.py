...
def process_fw_add_channel(message):
    ...
    try:
        ...
        if len(parts) < 3:
            bot.reply_to(message, "⚠️ Invalid format. Make sure to use spaces around the dashes: `Name - ID - Link`.", parse_mode="Markdown")
